...
public interface AuthLogService  {
     ...
     * @return
     */
    public AuthLog findById(Object id);
     ...
     * @return
     */
    public boolean delete(AuthLog model);
     ...
     * @return
     */
    public boolean save(AuthLog model);
     ...
     */
    public boolean saveOrUpdate(AuthLog model);
     ...
     * @return
     */
    public boolean update(AuthLog model);
